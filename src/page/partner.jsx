...
const partners: Partner[] = [
  ...
  },
  {
    ...
    description: "Rwanda's national utility company driving electrification and sustainable energy access throughout the country.",
    focus: 'National Utility',
    color: 'from-blue-500/20 to-cyan-500/20',
  },
  {
    name: 'Global Energy Group',
    description: 'International energy services provider specializing in offshore and onshore energy infrastructure development.',
    focus: 'Energy Infrastructure',
    color: 'from-emerald-500/20 to-teal-500/20',
  },
  {
    name: 'China Energy',
    description: "One of the world's largest power companies, partnering on large-scale generation projects and technology transfer initiatives.",
                ...
                <div className="p-8">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <span className="text-xs text-accent font-medium uppercase tracking-wider">{partner.focus}</span>
                    </div>
